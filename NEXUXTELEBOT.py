...
api_id = "29008552"
api_hash = "9cbecaa2da02b57aca45d5cad763fb25"
bot_token = "7107301786:AAHjBExUFjpx9ggdyF8dw4CLiV6xPSVJlJI"
...
/generate 123456 10
/generate 123456xxxx|xx|xx|xxx 3
...
/gen 123456
    ...
    markup.add(InlineKeyboardButton("↬ ᔆ ᴾ ᴱ ᴱ ᴰ ™ ⌁🧃", url="https://t.me/GODXNEXU"))
    bot.send_photo(message.chat.id, "https://telegra.ph/file/f3c17b44036443cee2b7c.jpg", caption=help_text, reply_markup=markup)
...
def generate(message):
    try:
        ...
        if count > 100000:
            bot.reply_to(message, "الحد الأقصى لعدد البطاقات هو 100,000.")
            return
        ...
        bot.reply_to(message, f"حدث خطأ:-\n `{e}`\n\n راسل المطور لحل المشكله :- @GODXNEXU")
...
def add_reaction(message):
    try:
        requests.post(f"https://api.telegram.org/bot{bot.token}/setMessageReaction", json={
            "chat_id": message.chat.id,
            "message_id": message.message_id,
            "reaction": [{"type": 'emoji', "emoji": "❤️‍🔥"}]
        })
    except Exception as e:
        bot.reply_to(message, f"حدث خطأ أثناء إضافة التفاعل: {e}")
